...
public:
  WellnessLevels()
      : steps(0), strength(0), stress(0), relations(0), school(0),
        confidence(0) {}
  ...
  std::string detailed_describe() const;
  ...
  /**
   * Amount of "strength", ie general physical ability. Sort of an integral of
   * steps. Should increase by 1 for each 1,000 steps taken in a day. Daily
   * increase of 0 is not a lot; 20 is a lot
   */
  int strength;
